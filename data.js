...
const TKA_DATA = {
  ...
  texts: [
    ...
    // ----------------------------------------------------
    {
      ...
      sourceCitation: '(adapted from https://www.tristandc.com)',
      paragraphs: [
        'Tristan da Cunha is a remote volcanic archipelago in the South Atlantic Ocean, located over 2,500 kilometers from the nearest mainland of South Africa. As the most isolated inhabited island on Earth, it is defined by its dramatic and formidable geography. The island rises steeply from the ocean depths, dominated by the active volcano Queen Mary\'s Peak, which reaches an elevation of 2,060 meters. Its rugged coastline consists of sheer basalt cliffs that drop straight into the churning sea, offering few natural landing spots for vessels.',
        'The only settlement on the island, known as Edinburgh of the Seven Seas, is a collection of sturdy, brightly painted houses that stand in defiance of the harsh oceanic elements. Life here is governed by the unpredictable rhythms of the sea and the wind, far removed from the digital noise and fast pace of modern cities. There are no airports or luxury resorts; access is possible only via a multi-day ship journey from Cape Town, making a visit both a logistical challenge and a rare privilege.',
        'Despite its isolation, Tristan da Cunha possesses a unique and delicate ecosystem. The surrounding environment is a sanctuary of raw, untouched nature, where unique wildlife thrives in total isolation. Because of its remoteness, the island is a vital breeding ground for rare species, such as the Northern Rockhopper penguin and the Atlantic Yellow-nosed albatross. The island\'s vegetation, shaped by constant winds and moisture, consists mainly of hardy ferns, mosses, and low-growing shrubs, creating a stark yet captivating landscape that feels frozen in time.'
      ],
      vocabulary: [
    ...
    // ----------------------------------------------------
    {
      ...
      sourceCitation: '(adapted from https://www.irishtimes.com)',
      paragraphs: [
        'Cillian Murphy is an Irish actor widely recognized for his striking physical features and his intense, transformative performances on both stage and screen. Born in Douglas, County Cork, Murphy possesses a distinct aesthetic characterized by his sharp, chiseled jawline, lean build, and exceptionally clear, translucent blue eyes. These eyes have become a hallmark of his cinematic presence, often described by directors as a powerful tool capable of conveying profound emotion without the need for spoken words.',
        'Beyond his captivating appearance, Murphy is celebrated for his rigorous work ethic and meticulous approach to character development. Unlike many Hollywood stars, he leads a private life away from the limelight, often expressing a preference for the quietude of his home in Ireland over the glamour of red carpets. This reserved nature contributes to his enigmatic public image, allowing audiences to view him purely through the lens of the characters he portrays rather than his celebrity persona.',
        'In his acting career, Murphy has consistently chosen challenging, complex roles that demand emotional depth. Whether portraying a conflicted soldier, a criminal mastermind, or a historical scientist, he submerges himself fully into the psychology of his subjects. His ability to project quiet intensity—using subtle micro-expressions and deliberate body language—has earned him critical acclaim and solidified his reputation as one of the most dedicated artists of his generation.'
      ],
      vocabulary: [
    ...
    // ----------------------------------------------------
    {
      ...
      sourceCitation: '(adapted from https://www.croptrust.org)',
      paragraphs: [
        'Deep inside a mountain on a remote island in the Svalbard archipelago, halfway between mainland Norway and the North Pole, lies the Svalbard Global Seed Vault. Carved 130 meters into the solid sandstone of Mount Platåfjellet, this facility is specifically designed to protect the world\'s crop diversity from potential natural or man-made disasters. The entrance to the vault is a striking, rectangular concrete wedge that juts out from the snow-covered mountain, illuminated by a glittering light installation that makes it visible for miles across the dark polar landscape.',
        'Behind massive steel doors and reinforced concrete walls lie three large subterranean chambers, kept at a constant temperature of -18 degrees Celsius. These chambers house millions of duplicate seed samples sent from gene banks around the globe, sealed in specialized three-ply foil packages to prevent moisture and decay. Even if the facility\'s automated cooling systems were to fail, the surrounding permafrost would keep the seeds frozen for decades, ensuring that humanity\'s agricultural heritage remains safe regardless of external catastrophes.',
        'The environment surrounding the Seed Vault is brutal and unforgiving, serving as a natural barrier to unwanted intrusion. In winter, the region is plunged into a constant polar night where the sun never rises, and the landscape becomes an endless expanse of white snow and jagged blue ice. The climate is dominated by biting winds and extreme temperatures that frequently drop to -25 degrees Celsius. This desolate setting, devoid of trees and human settlements, reinforces the vault\'s status as a fortress of survival.',
        'The Svalbard Global Seed Vault is not just a storage facility; it is a symbol of global unity and foresight. It provides a sense of security for nations that rely on these biological resources to rebuild their food systems in times of crisis. By holding the history of human farming inside its frozen walls, the vault ensures that the foundations of life remain safe for generations to come, standing as a quiet testament to humanity\'s shared responsibility for the planet.'
      ],
      vocabulary: [
    ...
    // ----------------------------------------------------
    {
      ...
      sourceCitation: '(adapted from https://vanessanakate.com)',
      paragraphs: [
        'Vanessa Nakate\'s journey as a climate activist began in January 2019, after she became deeply concerned about the unusually high temperatures in her home country, Uganda. Armed with a business administration degree, she felt a profound responsibility to protect her community from the devastating impacts of climate change. Inspired by youth movements in Europe, Nakate decided to take action, launching a strike outside the gates of the Ugandan Parliament in Kampala. For months, she stood alone with her handmade signs, demanding that the government acknowledge climate emergencies.',
        'Despite initial indifference from the public, Nakate\'s persistence transformed her solo protest into a nationwide movement. In late 2019, she founded the Rise Up Movement, a platform designed to amplify the voices of African climate activists who were often overlooked by Western media. Her international profile rose significantly when she was invited to speak at the World Economic Forum in Davos in 2020. However, this event was also marked by controversy when news agencies cropped her out of a photo with prominent European activists, sparking a global conversation about racial bias and the marginalization of African voices in environmental discussions.',
        'Rather than being discouraged by the Davos incident, Nakate used the media attention to demand greater inclusivity in the global climate fight. She shifted some of her focus toward practical solutions, launching the Vash Green Schools Project. This initiative installs solar panels and eco-friendly cookstoves in rural Ugandan schools, reducing their dependence on firewood while creating cleaner learning environments. She also started advocating for the education of girls, linking it directly to climate resilience and community empowerment.',
        'Today, Vanessa Nakate is recognized as a global leader in environmental justice. She has published a memoir titled A Bigger Picture and serves as a Goodwill Ambassador for UNICEF. Through her speeches at international summits, she continues to remind world leaders that Africa, despite contributing less than four percent of global carbon emissions, suffers some of the worst consequences of climate change. Her life work has proven that persistence and moral clarity can spark a massive shift in global awareness.'
      ],
      vocabulary: [
